...
public class USD implements Serializable {
    ...
    @ColumnInfo(name = "usd_volume_24h")
    @SerializedName("volume_24h")
    @Expose
    private Float volume_24h;

    @ColumnInfo(name = "usd_market_cap")
    @SerializedName("market_cap")
    @Expose
    private Float market_cap;

    @ColumnInfo(name = "usd_percent_change_1h")
    @SerializedName("percent_change_1h")
    @Expose
    private Float percent_change_1h;

    @ColumnInfo(name = "usd_percent_change_24h")
    @SerializedName("percent_change_24h")
    @Expose
    private Float percent_change_24h;

    @ColumnInfo(name = "usd_percent_change_7d")
